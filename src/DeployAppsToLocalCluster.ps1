...
try {
    ...
    Write-Host "Please wait a minute until cluster nodes are ready." -ForegroundColor Green
    Write-Host ""
    ...
    Write-Host "Error installing Business Platform to local cluster:" -ForegroundColor Red 
